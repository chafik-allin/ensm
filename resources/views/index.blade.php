		...
		<div class="row">
			<div class="col-lg-5 col-md-6 align-self-center">
				<div class="image-block two bg-about">
					<img class="img-fluid" src="{{asset('images/speakers/featured-speaker-two.jpg')}}" alt="">
				</div>
			</div>
			...
			<div class="col-12">
				...
				<div class="speaker-slider">
					<div class="speaker-image">
						<img src="{{asset('images/speakers/speaker-full-one.jpg')}}" alt="speaker" class="img-fluid">
					...
					<div class="speaker-image">
						<img src="{{asset('images/speakers/speaker-full-two.jpg')}}" alt="speaker" class="img-fluid">
						<div class="primary-overlay text-center">
							<h5>GEORGE G. HERNANDEZ</h5>
							<p>CEO Rancom Motor</p>
							<ul class="list-inline">
					...
					<div class="speaker-image">
						<img src="{{asset('images/speakers/speaker-full-three.jpg')}}" alt="speaker" class="img-fluid">
						<div class="primary-overlay text-center">
							<h5>GEORGE G. HERNANDEZ</h5>
							<p>CEO Rancom Motor</p>
							<ul class="list-inline">
					...
					<div class="speaker-image">
						<img src="{{asset('images/speakers/speaker-full-four.jpg')}}" alt="speaker" class="img-fluid">
						<div class="primary-overlay text-center">
							<h5>GEORGE G. HERNANDEZ</h5>
							<p>CEO Rancom Motor</p>
							<ul class="list-inline">
					...
					<div class="speaker-image">
						<img src="{{asset('images/speakers/speaker-full-five.jpg')}}" alt="speaker" class="img-fluid">
						<div class="primary-overlay text-center">
							<h5>GEORGE G. HERNANDEZ</h5>
							<p>CEO Rancom Motor</p>
							<ul class="list-inline">
		...
		<div class="row no-gutters">
			<div class="col-lg-6">
				<article class="news-post-hr">
					<div class="post-thumb">
						<a href="news-single.html">
							<img src="{{asset('images/news/post-thumb-hr-one.jpg')}}" alt="post-image" class="img-fluid">
						</a>
					</div>
			...
			<div class="col-lg-6">
				<article class="news-post-hr">
					<div class="post-thumb">
						<a href="news-single.html">
							<img src="{{asset('images/news/post-thumb-hr-two.jpg')}}" alt="post-image" class="img-fluid">
						</a>
					</div>
					<div class="post-contents border-top">
						<div class="post-title"><h6><a href="news-single.html">Default title here</a></h6></div>
			...
			<div class="col-lg-6">
				<article class="news-post-hr">
					<div class="post-thumb">
						<a href="news-single.html">
							<img src="{{asset('images/news/post-thumb-hr-three.jpg')}}" alt="post-image" class="img-fluid">
						</a>
					</div>
			...
			<div class="col-lg-6">
				<article class="news-post-hr">
					<div class="post-thumb">
						<a href="news-single.html">
							<img src="{{asset('images/news/post-thumb-hr-four.jpg')}}" alt="post-image" class="img-fluid">
						</a>
					</div>
					<div class="post-contents">
						<div class="post-title"><h6><a href="news-single.html">Default title here</a></h6></div>
	...
	<div class="container-fluid p-0">
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="{{asset('images/gallery/gallery-full-one.jpg')}}" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
        				<a class="image-popup" data-effect="mfp-with-zoom" href="{{asset('images/gallery/gallery-full-popup-one.jpg')}}"><i class="fa fa-picture-o"></i></a>
        			</div>
				</div>
			</div>
			<!-- Gallery Image -->
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-two.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-three.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-four.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-five.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-six.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-seven.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
			...
			<div class="col-lg-3 col-md-4">
				<div class="image">
					<img src="images/gallery/gallery-full-eight.jpg" alt="gallery-image" class="img-fluid">
					<div class="primary-overlay">
