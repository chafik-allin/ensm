				...
				<div class="block">
					...
					<article class="blog-post single">
						<div class="post-thumb">
							<img src="{{asset('images/news/single-post.jpg')}}" alt="post-image" class="img-fluid">
						</div>
					...
					<div class="comments">
						...
						<div class="media comment">
							<img src="{{asset('images/speakers/speaker-thumb-four.jpg')}}" alt="image">
							<div class="media-body">
								...
								<!-- Nested Comment -->
								<div class="media comment">
									<img src="{{asset('images/speakers/speaker-thumb-three.jpg')}}" alt="image">
									<div class="media-body">
										<h6>Jonathan Doe</h6>
										<ul class="list-inline">
											<li class="list-inline-item"><span class="fa fa-calendar"></span>Mar 20, 2016</li>
						...
						<!-- Comment -->
						<div class="media comment">
							<img src="{{asset('images/speakers/speaker-thumb-two.jpg')}}" alt="image">
							<div class="media-body">
								<h6>Adam Smith</h6>
								<ul class="list-inline">
									<li class="list-inline-item"><span class="fa fa-calendar"></span>Mar 20, 2016</li>
			...
			<div class="col-lg-4 col-md-10 mx-auto">
				<div class="sidebar">
					...
					<div class="widget latest-post">
						...
						<!-- Post -->
						<div class="media">
							<img src="{{asset('images/news/post-thumb-sm-one.jpg')}}" class="img-fluid" alt="post-thumb">
							<div class="media-body">
						...
						<!-- Post -->
						<div class="media">
							<img src="{{asset('images/news/post-thumb-sm-two.jpg')}}" class="img-fluid" alt="post-thumb">
							<div class="media-body">
								<h6><a href="">Nam hendrerit eros in ligula suscipit suscipit</a></h6>
								<p href="#"><span class="fa fa-calendar"></span>02 Feb, 2017</p>
							</div>
						...
						<!-- Post -->
						<div class="media">
							<img src="{{asset('images/news/post-thumb-sm-three.jpg')}}" class="img-fluid" alt="post-thumb">
							<div class="media-body">
								<h6><a href="">Nam hendrerit eros in ligula suscipit suscipit</a></h6>
								<p href="#"><span class="fa fa-calendar"></span>02 Feb, 2017</p>
							</div>
						...
						<!-- Post -->
						<div class="media">
							<img src="{{asset('images/news/post-thumb-sm-four.jpg')}}" class="img-fluid" alt="post-thumb">
							<div class="media-body">
								<h6><a href="">Nam hendrerit eros in ligula suscipit suscipit</a></h6>
								<p href="#"><span class="fa fa-calendar"></span>02 Feb, 2017</p>
							</div>
